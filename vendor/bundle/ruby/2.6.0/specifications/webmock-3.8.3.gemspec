...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/bblimke/webmock/issues", "changelog_uri" => "https://github.com/bblimke/webmock/blob/v3.8.3/CHANGELOG.md", "documentation_uri" => "https://www.rubydoc.info/gems/webmock/3.8.3", "source_code_uri" => "https://github.com/bblimke/webmock/tree/v3.8.3", "wiki_uri" => "https://github.com/bblimke/webmock/wiki" } if s.respond_to? :metadata=
