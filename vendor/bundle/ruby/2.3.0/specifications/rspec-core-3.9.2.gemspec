# -*- encoding: utf-8 -*-
# stub: rspec-core 3.9.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<rspec-support>.freeze, ["~> 3.9.3"])
      ...
      s.add_dependency(%q<rspec-support>.freeze, ["~> 3.9.3"])
